...
export const CLUBS_DATABASE: ClubData[] = [
  ...
  },
  {
    ...
    bankDetails: {
      ...
      accountHolder: 'Complejo Deportivo Las Cañas SRL',
      alias: 'lascanas.deportes',
      cbu: '0000003100098765432102',
      cuit: '30-71889900-3',
    },
    paymentMethods: ['TRANSFER'],
    mpConnected: false,
...
export function generateClubSlots(club: ClubData, sport: SportCategory): GeneratedSlot[] {
  ...
  // Generamos turnos variando disponibilidad según horario para realismo
  matchingCourts.forEach((court, cIdx) => {
    timeSlots.forEach((time) => {
      // Dejamos ocupados solo un par de turnos picos (ej: 18:00 o 21:00 en la cancha 2)
      const isOccupied = (cIdx === 1 && (time === '18:00' || time === '21:00')) ||
                         (cIdx === 0 && time === '20:30' && court.sport === 'FUTBOL')
